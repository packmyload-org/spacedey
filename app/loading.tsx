...
export default function Loading() {
  return (
    <div className="flex min-h-screen flex-col">
      <header className="bg-[#0d1d73] px-6 py-4 lg:px-12">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="h-8 w-32 animate-pulse rounded bg-white/25"></div>
          ...
          <div className="h-8 w-8 animate-pulse rounded-full bg-white/25"></div>
        </div>
      </header>
