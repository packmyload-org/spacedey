...
//   const [storageSize, setStorageSize] = React.useState<string>("any");
//   const [viewMode, setViewMode] = React.useState<"list" | "map">("list");
//   const [showFilters, setShowFilters] = React.useState<boolean>(false);

//   const facilities = [
//     { id: 1, name: "Downtown Manhattan", address: "123 Broadway, New York, NY 10001", distance: "0.5 miles", price: 129, features: ["24/7 Access", "Climate Controlled"], unitsAvailable: 5, rating: 4.8 },
//     { id: 2, name: "Brooklyn Heights", address: "456 Atlantic Ave, Brooklyn, NY 11217", distance: "2.3 miles", price: 99, features: ["Climate Controlled", "Elevator Access"], unitsAvailable: 3, rating: 4.9 },
//     { id: 3, name: "Queens Plaza", address: "789 Queens Blvd, Queens, NY 11101", distance: "3.8 miles", price: 149, features: ["Drive-in Access", "Security Camera"], unitsAvailable: 8, rating: 4.7 },
//   ];
...
//             <button className="mt-6 w-full md:w-auto px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
...
//                   <span>•</span>
//                   <span className="text-green-600 font-medium">{facility.unitsAvailable} units available</span>
//                 </div>
//                 <div className="flex flex-wrap gap-2 mb-4">
//                   {facility.features.slice(0, 2).map((feature, idx) => (
//                     <span key={idx} className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">{feature}</span>
//                   ))}
//                 </div>
