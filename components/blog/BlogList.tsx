...
//   {
//     id: '1',
//     title: 'Creating a Self-Storage Inventory Checklist: Best Tips to Keep Your Storage Organized',
//     date: 'July 24, 2025',
//     excerpt: 'Learn tips to organise and manage your storage inventory with ease. Discover strategies for tracking, categorizing, and maintaining items long-term.',
...
//     date: 'July 15, 2025',
//     excerpt: "Learn the essential do's and don'ts of furniture storage to keep your pieces safe, clean, and damage-free in long-term storage.",
...
//     date: 'July 10, 2025',
//     excerpt: 'Get expert tips on bicycle storage solutions in self storage units. Learn how to prep, protect, and store your bike safely for the long term.',
...
//   {
//     id: '4',
//     title: "Living With Roommates? Here's What to Store Offsite to Make Room for Peace",
//     date: 'July 2, 2025',
//     excerpt: 'Living with a roommate and running out of space? Discover smart offsite storage tips to stay organized and reduce clutter.',
...
//   {
//     id: '5',
//     title: 'Warehouse or Business Storage Units? How to Choose the Right Fit for Your Business',
//     date: 'June 26, 2025',
//     excerpt: 'Learn the key differences, pros and cons, and what to consider before choosing between warehouses or business storage units.',
//     image: 'https://blog.stufstorage.com/hubfs/postwoman-working-office%201.png',
//     author: 'David Thompson',
//     href: '#',
//   },
//   {
//     id: '6',
//     title: 'What to Store In Your Self Storage Units Before Your Summer Vacation',
//     date: 'June 19, 2025',
//     excerpt: 'Heading off on a summer getaway? Discover what to safely keep in self storage units before you travel.',
...
//     date: 'June 11, 2025',
//     excerpt: 'Planning a summer getaway? Discover how summer storage helps protect your belongings and streamline your travel plans.',
...
//           <span className="text-sm font-semibold text-blue-900">{post.author}</span>
...
//             {defaultPosts.slice(0, 2).map((post) => (
...
//             {defaultPosts.slice(2, 5).map((post) => (
//               <BlogCard key={post.id} post={post} />
//             ))}
//           </div>
...
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//             {defaultPosts.slice(5, 7).map((post) => (
//               <BlogCard key={post.id} post={post} />
//             ))}

//             {/* Newsletter Card */}
//             <div className="bg-blue-50 border border-blue-200 rounded-2xl p-8 flex flex-col justify-between h-full">
//               <div>
...
//                 </button>
//                 {subscribed && (
//                   <p className="text-green-600 text-sm text-center">Thanks for subscribing!</p>
//                 )}
//               </form>
//             </div>
//           </div>
